...
package net.yazibacloud.android.datamodel;
...
import net.yazibacloud.android.ui.adapter.DiskLruImageCache;
...
public class ThumbnailsCacheManager {
    ...
    public static Bitmap mDefaultImg = 
            BitmapFactory.decodeResource(
                    ...
                    net.yazibacloud.android.R.drawable.file_image
            );
    ...
    public static class ThumbnailGenerationTask extends AsyncTask<Object, Void, Bitmap> {
        ...
        private int getThumbnailDimension(){
            ...
            return Math.round(r.getDimension(net.yazibacloud.android.R.dimen.file_icon_size_grid));
        }
