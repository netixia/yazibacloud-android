...
package net.yazibacloud.android.services;
...
import net.yazibacloud.android.lib.common.accounts.AccountUtils;
                ...
                try {
                    ...
                    if (mLastTarget == null || !mLastTarget.equals(next.first)) {
                        ...
                        if (mLastTarget.mAccount != null) {
                            ...
                            OwnCloudVersion version = net.yazibacloud.android.authentication.AccountUtils.getServerVersion(
            ...
            if (!operationIntent.hasExtra(EXTRA_ACCOUNT) && 
                ...
                if (action.equals(ACTION_CREATE_SHARE_VIA_LINK)) {  // Create public share via link
                    ...
                    operation = new OAuth2GetAccessToken(
                            getString(net.yazibacloud.android.R.string.oauth2_client_id),
                            getString(net.yazibacloud.android.R.string.oauth2_redirect_uri),
                            getString(net.yazibacloud.android.R.string.oauth2_grant_type),
