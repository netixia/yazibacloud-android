...
public class AccountAuthenticator extends AbstractAccountAuthenticator {
    ...
    public Bundle addAccount(AccountAuthenticatorResponse response,
        ...
        if (mContext.getResources().getBoolean(net.yazibacloud.android.R.bool.multiaccount_support) || accounts.length < 1) {
            try {
            ...
            final String message = String.format(mContext.getString(net.yazibacloud.android.R.string.auth_unsupported_multiaccount), mContext.getString(net.yazibacloud.android.R.string.app_name));
