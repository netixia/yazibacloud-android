...
package net.yazibacloud.android.authentication;

import java.util.Locale;

import net.yazibacloud.android.MainApp;
import net.yazibacloud.android.lib.common.accounts.AccountTypeUtils;
...
public class AccountUtils {
    ...
    public static void updateAccountVersion(Context context) {
        ...
        if ( currentAccount != null ) {
            String currentAccountVersion = accountMgr.getUserData(currentAccount, net.yazibacloud.android.lib.common.accounts.AccountUtils.Constants.KEY_OC_ACCOUNT_VERSION);
            ...
            if (currentAccountVersion == null) {
                ...
                for (Account account : ocAccounts) {
                    ...
                    serverUrl = accountMgr.getUserData(account, net.yazibacloud.android.lib.common.accounts.AccountUtils.Constants.KEY_OC_BASE_URL);
                    username = account.name.substring(0, account.name.lastIndexOf('@'));
                    newAccountName = net.yazibacloud.android.lib.common.accounts.AccountUtils.
                    ...
                    if (!newAccountName.equals(account.name)) {
                        ...
                        // copy base URL
                        accountMgr.setUserData(newAccount, net.yazibacloud.android.lib.common.accounts.AccountUtils.Constants.KEY_OC_BASE_URL, serverUrl);

                        // copy server version
                        accountMgr.setUserData(
                                newAccount,
                                net.yazibacloud.android.lib.common.accounts.AccountUtils.Constants.KEY_OC_VERSION,
                                accountMgr.getUserData(account, net.yazibacloud.android.lib.common.accounts.AccountUtils.Constants.KEY_OC_VERSION)
                        );

                        // copy cookies
                        accountMgr.setUserData(
                                newAccount,
                                net.yazibacloud.android.lib.common.accounts.AccountUtils.Constants.KEY_COOKIES,
                                accountMgr.getUserData(account, net.yazibacloud.android.lib.common.accounts.AccountUtils.Constants.KEY_COOKIES)
                        );

                        // copy type of authentication
                        String isSamlStr = accountMgr.getUserData(account, net.yazibacloud.android.lib.common.accounts.AccountUtils.Constants.KEY_SUPPORTS_SAML_WEB_SSO);
                        boolean isSaml = "TRUE".equals(isSamlStr);
                        if (isSaml) {
                            accountMgr.setUserData(newAccount, net.yazibacloud.android.lib.common.accounts.AccountUtils.Constants.KEY_SUPPORTS_SAML_WEB_SSO, "TRUE");
                        }

                        String isOauthStr = accountMgr.getUserData(account, net.yazibacloud.android.lib.common.accounts.AccountUtils.Constants.KEY_SUPPORTS_OAUTH2);
                        boolean isOAuth = "TRUE".equals(isOauthStr);
                        if (isOAuth) {
                            accountMgr.setUserData(newAccount, net.yazibacloud.android.lib.common.accounts.AccountUtils.Constants.KEY_SUPPORTS_OAUTH2, "TRUE");
                        }
                    ...
                    accountMgr.setUserData(
                            newAccount, net.yazibacloud.android.lib.common.accounts.AccountUtils.Constants.KEY_OC_ACCOUNT_VERSION, Integer.toString(ACCOUNT_VERSION)
                    );
    ...
    public static OwnCloudVersion getServerVersion(Account account) {
        ...
        if (account != null) {
            ...
            String serverVersionStr = accountMgr.getUserData(account, net.yazibacloud.android.lib.common.accounts.AccountUtils.Constants.KEY_OC_VERSION);
