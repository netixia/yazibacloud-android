...
import net.yazibacloud.android.lib.common.network.WebdavUtils;
...
import net.yazibacloud.android.ui.activity.ShareActivity;
import net.yazibacloud.android.ui.dialog.ShareLinkToDialog;
...
public class FileOperationsHelper {
                ...
                try {
                    mFileActivity.startActivity(
                            Intent.createChooser(
                                    openFileWithIntent, mFileActivity.getString(net.yazibacloud.android.R.string.actionbar_open_with)
                            )
                    );
    ...
    private void showNoAppForFileTypeToast(Context context) {
        Toast.makeText(context,
                net.yazibacloud.android.R.string.file_list_no_app_for_file_type, Toast.LENGTH_SHORT)
                .show();
    }
    ...
    public void shareFileViaLink(OCFile file, String password) {
        if (isSharedSupported()) {
            if (file != null) {
                mFileActivity.showLoadingDialog(
                        mFileActivity.getApplicationContext().
                                getString(net.yazibacloud.android.R.string.wait_a_moment)
                );
            ...
            Toast t = Toast.makeText(
                    mFileActivity, mFileActivity.getString(net.yazibacloud.android.R.string.share_link_no_support_share_api),
                    Toast.LENGTH_LONG
            );
            t.show();
        }
    ...
    private void queueShareIntent(Intent shareIntent){
        if (isSharedSupported()) {
            ...
            Toast t = Toast.makeText(mFileActivity,
                    mFileActivity.getString(net.yazibacloud.android.R.string.share_link_no_support_share_api),
                    Toast.LENGTH_LONG);
            t.show();
