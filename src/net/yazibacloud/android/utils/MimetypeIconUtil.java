...
public class MimetypeIconUtil {
    ...
    public static int getFolderTypeIconId(boolean isSharedViaUsers, boolean isSharedViaLink) {
        if (isSharedViaLink) {
            return net.yazibacloud.android.R.drawable.folder_public;
        } else if (isSharedViaUsers) {
            return net.yazibacloud.android.R.drawable.shared_with_me_folder;
        }

        return net.yazibacloud.android.R.drawable.ic_menu_archive;
    }
    ...
    private static int determineIconIdByMimeTypeList(List<String> mimetypes) {
        ...
        if (mimetypes == null || mimetypes.size() < 1) {
            return net.yazibacloud.android.R.drawable.file;
        } else {
    ...
    private static void populateMimeTypeIconMapping() {
        MIMETYPE_TO_ICON_MAPPING.put("application/coreldraw", net.yazibacloud.android.R.drawable.file_image);
        MIMETYPE_TO_ICON_MAPPING.put("application/epub+zip", net.yazibacloud.android.R.drawable.file_text);
        MIMETYPE_TO_ICON_MAPPING.put("application/font-sfnt", net.yazibacloud.android.R.drawable.file_image);
        MIMETYPE_TO_ICON_MAPPING.put("application/font-woff", net.yazibacloud.android.R.drawable.file_image);
        MIMETYPE_TO_ICON_MAPPING.put("application/illustrator", net.yazibacloud.android.R.drawable.file_image);
        MIMETYPE_TO_ICON_MAPPING.put("application/javascript", net.yazibacloud.android.R.drawable.file_code);
        MIMETYPE_TO_ICON_MAPPING.put("application/json", net.yazibacloud.android.R.drawable.file_code);
        MIMETYPE_TO_ICON_MAPPING.put("application/msaccess", net.yazibacloud.android.R.drawable.file);
        MIMETYPE_TO_ICON_MAPPING.put("application/msexcel", net.yazibacloud.android.R.drawable.file_xls);
        MIMETYPE_TO_ICON_MAPPING.put("application/mspowerpoint", net.yazibacloud.android.R.drawable.file_ppt);
        MIMETYPE_TO_ICON_MAPPING.put("application/msword", net.yazibacloud.android.R.drawable.file_doc);
        MIMETYPE_TO_ICON_MAPPING.put("application/octet-stream", net.yazibacloud.android.R.drawable.file);
        MIMETYPE_TO_ICON_MAPPING.put("application/postscript", net.yazibacloud.android.R.drawable.file_image);
        MIMETYPE_TO_ICON_MAPPING.put("application/pdf", net.yazibacloud.android.R.drawable.file_pdf);
        MIMETYPE_TO_ICON_MAPPING.put("application/rss+xml", net.yazibacloud.android.R.drawable.file_code);
        MIMETYPE_TO_ICON_MAPPING.put("application/rtf", net.yazibacloud.android.R.drawable.file);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.android.package-archive", net.yazibacloud.android.R.drawable.file_zip);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.ms-excel", net.yazibacloud.android.R.drawable.file_xls);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.ms-excel.addin.macroEnabled.12", net.yazibacloud.android.R.drawable.file_xls);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.ms-excel.sheet.binary.macroEnabled.12", net.yazibacloud.android.R.drawable.file_xls);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.ms-excel.sheet.macroEnabled.12", net.yazibacloud.android.R.drawable.file_xls);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.ms-excel.template.macroEnabled.12", net.yazibacloud.android.R.drawable.file_xls);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.ms-fontobject", net.yazibacloud.android.R.drawable.file_image);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.ms-powerpoint", net.yazibacloud.android.R.drawable.file_ppt);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.ms-powerpoint.addin.macroEnabled.12", net.yazibacloud.android.R.drawable.file_ppt);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.ms-powerpoint.presentation.macroEnabled.12", net.yazibacloud.android.R.drawable.file_ppt);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.ms-powerpoint.slideshow.macroEnabled.12", net.yazibacloud.android.R.drawable.file_ppt);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.ms-powerpoint.template.macroEnabled.12", net.yazibacloud.android.R.drawable.file_ppt);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.ms-word.document.macroEnabled.12", net.yazibacloud.android.R.drawable.file_doc);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.ms-word.template.macroEnabled.12", net.yazibacloud.android.R.drawable.file_doc);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.oasis.opendocument.presentation", net.yazibacloud.android.R.drawable.file_ppt);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.oasis.opendocument.presentation-template", net.yazibacloud.android.R.drawable.file_ppt);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.oasis.opendocument.spreadsheet", net.yazibacloud.android.R.drawable.file_xls);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.oasis.opendocument.spreadsheet-template", net.yazibacloud.android.R.drawable.file_xls);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.oasis.opendocument.text", net.yazibacloud.android.R.drawable.file_doc);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.oasis.opendocument.text-master", net.yazibacloud.android.R.drawable.file_doc);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.oasis.opendocument.text-template", net.yazibacloud.android.R.drawable.file_doc);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.oasis.opendocument.text-web", net.yazibacloud.android.R.drawable.file_doc);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.openxmlformats-officedocument.presentationml.presentation", net.yazibacloud.android.R.drawable.file_ppt);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.openxmlformats-officedocument.presentationml.slideshow", net.yazibacloud.android.R.drawable.file_ppt);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.openxmlformats-officedocument.presentationml.template", net.yazibacloud.android.R.drawable.file_ppt);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", net.yazibacloud.android.R.drawable.file_xls);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.openxmlformats-officedocument.spreadsheetml.template", net.yazibacloud.android.R.drawable.file_xls);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.openxmlformats-officedocument.wordprocessingml.document", net.yazibacloud.android.R.drawable.file_doc);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.openxmlformats-officedocument.wordprocessingml.template", net.yazibacloud.android.R.drawable.file_doc);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-7z-compressed", net.yazibacloud.android.R.drawable.file_zip);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-bin", net.yazibacloud.android.R.drawable.file_application);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-cbr", net.yazibacloud.android.R.drawable.file_text);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-compressed", net.yazibacloud.android.R.drawable.file_zip);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-dcraw", net.yazibacloud.android.R.drawable.file_image);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-deb", net.yazibacloud.android.R.drawable.file_zip);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-font", net.yazibacloud.android.R.drawable.file_image);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-gimp", net.yazibacloud.android.R.drawable.file_image);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-gzip", net.yazibacloud.android.R.drawable.file_zip);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-ms-dos-executable", net.yazibacloud.android.R.drawable.file_application);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-msi", net.yazibacloud.android.R.drawable.file_application);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-iwork-numbers-sffnumbers", net.yazibacloud.android.R.drawable.file_xls);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-iwork-keynote-sffkey", net.yazibacloud.android.R.drawable.file_ppt);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-iwork-pages-sffpages", net.yazibacloud.android.R.drawable.file_doc);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-perl", net.yazibacloud.android.R.drawable.file_code);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-photoshop", net.yazibacloud.android.R.drawable.file_image);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-php", net.yazibacloud.android.R.drawable.file_code);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-rar-compressed", net.yazibacloud.android.R.drawable.file_zip);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-shockwave-flash", net.yazibacloud.android.R.drawable.file_application);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-tar", net.yazibacloud.android.R.drawable.file_zip);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-tex", net.yazibacloud.android.R.drawable.file_text);
        MIMETYPE_TO_ICON_MAPPING.put("application/xml", net.yazibacloud.android.R.drawable.file_text);
        MIMETYPE_TO_ICON_MAPPING.put("application/yaml", net.yazibacloud.android.R.drawable.file_code);
        MIMETYPE_TO_ICON_MAPPING.put("application/zip", net.yazibacloud.android.R.drawable.file_zip);
        MIMETYPE_TO_ICON_MAPPING.put("database", net.yazibacloud.android.R.drawable.file);
        MIMETYPE_TO_ICON_MAPPING.put("httpd/unix-directory", net.yazibacloud.android.R.drawable.ic_menu_archive);
        MIMETYPE_TO_ICON_MAPPING.put("image/svg+xml", net.yazibacloud.android.R.drawable.file_image);
        MIMETYPE_TO_ICON_MAPPING.put("image/vector", net.yazibacloud.android.R.drawable.file_image);
        MIMETYPE_TO_ICON_MAPPING.put("text/calendar", net.yazibacloud.android.R.drawable.file_calendar);
        MIMETYPE_TO_ICON_MAPPING.put("text/css", net.yazibacloud.android.R.drawable.file_code);
        MIMETYPE_TO_ICON_MAPPING.put("text/csv", net.yazibacloud.android.R.drawable.file_xls);
        MIMETYPE_TO_ICON_MAPPING.put("text/html", net.yazibacloud.android.R.drawable.file_code);
        MIMETYPE_TO_ICON_MAPPING.put("text/vcard", net.yazibacloud.android.R.drawable.file_vcard);
        MIMETYPE_TO_ICON_MAPPING.put("text/x-c", net.yazibacloud.android.R.drawable.file_code);
        MIMETYPE_TO_ICON_MAPPING.put("text/x-c++src", net.yazibacloud.android.R.drawable.file_code);
        MIMETYPE_TO_ICON_MAPPING.put("text/x-h", net.yazibacloud.android.R.drawable.file_code);
        MIMETYPE_TO_ICON_MAPPING.put("text/x-python", net.yazibacloud.android.R.drawable.file_code);
        MIMETYPE_TO_ICON_MAPPING.put("text/x-shellscript", net.yazibacloud.android.R.drawable.file_code);
        MIMETYPE_TO_ICON_MAPPING.put("web", net.yazibacloud.android.R.drawable.file_code);
        MIMETYPE_TO_ICON_MAPPING.put("DIR", net.yazibacloud.android.R.drawable.ic_menu_archive);
    }
    ...
    private static void populateMainMimeTypeMapping() {
        MAINMIMETYPE_TO_ICON_MAPPING.put("audio", net.yazibacloud.android.R.drawable.file_sound);
        MAINMIMETYPE_TO_ICON_MAPPING.put("database", net.yazibacloud.android.R.drawable.file);
        MAINMIMETYPE_TO_ICON_MAPPING.put("httpd", net.yazibacloud.android.R.drawable.file_zip);
        MAINMIMETYPE_TO_ICON_MAPPING.put("image", net.yazibacloud.android.R.drawable.file_image);
        MAINMIMETYPE_TO_ICON_MAPPING.put("text", net.yazibacloud.android.R.drawable.file_text);
        MAINMIMETYPE_TO_ICON_MAPPING.put("video", net.yazibacloud.android.R.drawable.file_movie);
        MAINMIMETYPE_TO_ICON_MAPPING.put("web", net.yazibacloud.android.R.drawable.file_code);
    }
