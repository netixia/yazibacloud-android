...
public class FileStorageUtils {
    ...
    public static String getInstantUploadFilePath(Context context, String fileName) {
        ...
        String uploadPathdef = context.getString(net.yazibacloud.android.R.string.instant_upload_path);
    ...
    public static String getInstantVideoUploadFilePath(Context context, String fileName) {
        SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(context);
        String uploadVideoPathdef = context.getString(net.yazibacloud.android.R.string.instant_upload_path);
