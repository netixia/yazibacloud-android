...
package net.yazibacloud.android.widgets;
...
public class ActionEditText extends EditText {
    ...
    private void getAttrs(AttributeSet attr) {
        TypedArray a = getContext().obtainStyledAttributes(attr,
                net.yazibacloud.android.R.styleable.ActionEditText);
        optionOneString = a
                .getString(net.yazibacloud.android.R.styleable.ActionEditText_optionOneString);
        optionTwoString = a
                .getString(net.yazibacloud.android.R.styleable.ActionEditText_optionTwoString);
        optionOneColor = a.getColor(net.yazibacloud.android.R.styleable.ActionEditText_optionOneColor,
                0x00ff00);
        optionTwoColor = a.getColor(net.yazibacloud.android.R.styleable.ActionEditText_optionTwoColor,
                0xff0000);
        badgeClickCallback = a
                .getString(net.yazibacloud.android.R.styleable.ActionEditText_onBadgeClick);
    }
