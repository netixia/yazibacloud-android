...
package net.yazibacloud.android.notifications;
...
public class NotificationBuilderWithProgressBar extends NotificationCompat.Builder {
    ...
    public static NotificationCompat.Builder newNotificationBuilderWithProgressBar(Context context) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            ...
            return new NotificationCompat.Builder(context).
                    setColor(context.getResources().getColor(net.yazibacloud.android.R.color.primary));
        }
    }
    ...
    private NotificationBuilderWithProgressBar(Context context) {
        super(context);
        mContentView = new RemoteViews(context.getPackageName(), net.yazibacloud.android.R.layout.notification_with_progress_bar);
    ...
    public NotificationCompat.Builder setProgress(int max, int progress, boolean indeterminate) {
        mContentView.setProgressBar(net.yazibacloud.android.R.id.progress, max, progress, indeterminate);
        if (max > 0) {
            mContentView.setViewVisibility(net.yazibacloud.android.R.id.progressHolder, View.VISIBLE);
        } else {
            mContentView.setViewVisibility(net.yazibacloud.android.R.id.progressHolder, View.GONE);
        }
        return this;
    }
    ...
    public NotificationCompat.Builder setSmallIcon(int icon) {
        ...
        mContentView.setImageViewResource(net.yazibacloud.android.R.id.icon, icon);
        return this;
    }
    ...
    public NotificationCompat.Builder setContentTitle(CharSequence title) {
        ...
        mContentView.setTextViewText(net.yazibacloud.android.R.id.title, title);
        return this;
    }
    ...
    public NotificationCompat.Builder setContentText(CharSequence text) {
        ...
        mContentView.setTextViewText(net.yazibacloud.android.R.id.text, text);
        if (text != null && text.length() > 0) {
            mContentView.setViewVisibility(net.yazibacloud.android.R.id.text, View.VISIBLE);
        } else {
            mContentView.setViewVisibility(net.yazibacloud.android.R.id.text, View.GONE);
        }
        return this;
    }
