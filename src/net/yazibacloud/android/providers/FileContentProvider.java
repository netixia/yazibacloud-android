...
package net.yazibacloud.android.providers;
...
import net.yazibacloud.android.db.ProviderMeta;
...
public class FileContentProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        ...
        String authority = getContext().getResources().getString(net.yazibacloud.android.R.string.authority);
     ...
     *
     * See {@link net.yazibacloud.android.authentication.AccountUtils#updateAccountVersion(android.content.Context)}
     *
    ...
    private void updateAccountName(SQLiteDatabase db){
        ...
        try {
			...
			for (Account account : accounts) {
                ...
                serverUrl = ama.getUserData(account, net.yazibacloud.android.lib.common.accounts.AccountUtils.Constants.KEY_OC_BASE_URL);
                username = account.name.substring(0, account.name.lastIndexOf('@'));
                oldAccountName = net.yazibacloud.android.lib.common.accounts.AccountUtils.buildAccountNameOld(Uri.parse(serverUrl), username);
                newAccountName = net.yazibacloud.android.lib.common.accounts.AccountUtils.buildAccountName(Uri.parse(serverUrl), username);
