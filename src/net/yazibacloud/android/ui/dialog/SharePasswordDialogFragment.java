...
public class SharePasswordDialogFragment extends DialogFragment
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(net.yazibacloud.android.R.layout.password_dialog, null);

        // Setup layout
        EditText inputText = ((EditText)v.findViewById(net.yazibacloud.android.R.id.share_password));
        inputText.setText("");
        ...
        builder.setView(v)
               ...
               .setTitle(net.yazibacloud.android.R.string.share_link_password_title);
    ...
    public void onClick(DialogInterface dialog, int which) {
        if (which == AlertDialog.BUTTON_POSITIVE) {
            String password =
                    ((TextView)(getDialog().findViewById(net.yazibacloud.android.R.id.share_password)))
                        .getText().toString();

            if (password.length() <= 0) {
                Toast.makeText(
                        getActivity(),
                        net.yazibacloud.android.R.string.share_link_empty_password,
