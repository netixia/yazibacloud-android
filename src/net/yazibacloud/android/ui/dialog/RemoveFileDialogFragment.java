...
implements ConfirmationDialogFragment.ConfirmationDialogFragmentListener {
    ...
    public static RemoveFileDialogFragment newInstance(OCFile file) {
        ...
        int messageStringId = net.yazibacloud.android.R.string.confirmation_remove_alert;
        
        int negBtn = -1;
        if (file.isFolder()) {
            messageStringId = net.yazibacloud.android.R.string.confirmation_remove_folder_alert;
            negBtn = net.yazibacloud.android.R.string.confirmation_remove_local;
        } else if (file.isDown()) {
            negBtn = net.yazibacloud.android.R.string.confirmation_remove_local;
        }
        ...
        args.putInt(ARG_POSITIVE_BTN_RES, net.yazibacloud.android.R.string.common_yes);
        args.putInt(ARG_NEUTRAL_BTN_RES, net.yazibacloud.android.R.string.common_no);
