...
public class IndeterminateProgressDialog extends DialogFragment {
    ...
    public static IndeterminateProgressDialog newInstance(int messageId, boolean cancelable) {
        ...
        fragment.setStyle(DialogFragment.STYLE_NO_FRAME, net.yazibacloud.android.R.style.ownCloud_AlertDialog);
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(getActivity(), net.yazibacloud.android.R.style.ProgressDialogTheme);
        ...
        /// set message
        int messageId = getArguments().getInt(ARG_MESSAGE_ID, net.yazibacloud.android.R.string.placeholder_sentence);
