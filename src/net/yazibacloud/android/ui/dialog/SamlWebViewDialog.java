...
import net.yazibacloud.android.authentication.SsoWebViewClient;
...
public class SamlWebViewDialog extends DialogFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setStyle(DialogFragment.STYLE_NO_TITLE, net.yazibacloud.android.R.style.Theme_ownCloud_Dialog);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RelativeLayout ssoRootView = (RelativeLayout) inflater.inflate(net.yazibacloud.android.R.layout.sso_dialog,
