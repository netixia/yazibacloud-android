...
public class ConflictsResolveDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        return new AlertDialog.Builder(getActivity(), net.yazibacloud.android.R.style.Theme_ownCloud_Dialog)
                   .setIcon(net.yazibacloud.android.R.drawable.ic_warning)
                   .setTitle(net.yazibacloud.android.R.string.conflict_title)
                   .setMessage(String.format(getString(net.yazibacloud.android.R.string.conflict_message), remotepath))
                   .setPositiveButton(net.yazibacloud.android.R.string.conflict_use_local_version,
                   ...
                   .setNeutralButton(net.yazibacloud.android.R.string.conflict_keep_both,
                       new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                if (mListener != null)
                   ...
                   .setNegativeButton(net.yazibacloud.android.R.string.conflict_use_server_version,
                       new DialogInterface.OnClickListener() {
                           @Override
                           public void onClick(DialogInterface dialog, int which) {
                               if (mListener != null)
