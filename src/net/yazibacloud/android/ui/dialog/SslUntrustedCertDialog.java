...
import net.yazibacloud.android.ui.adapter.CertificateCombinedExceptionViewAdapter;
import net.yazibacloud.android.ui.adapter.SslCertificateViewAdapter;
import net.yazibacloud.android.ui.adapter.SslErrorViewAdapter;
import net.yazibacloud.android.ui.adapter.X509CertificateViewAdapter;
...
public class SslUntrustedCertDialog extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (mView == null) {
            mView = inflater.inflate(net.yazibacloud.android.R.layout.ssl_untrusted_cert_layout, container,  false);
        ...
        Button ok = (Button) mView.findViewById(net.yazibacloud.android.R.id.ok);
        ok.setOnClickListener(new OnCertificateTrusted());
        
        Button cancel = (Button) mView.findViewById(net.yazibacloud.android.R.id.cancel);
        cancel.setOnClickListener(new OnCertificateNotTrusted());
        
        Button details = (Button) mView.findViewById(net.yazibacloud.android.R.id.details_btn);
        details.setOnClickListener(new OnClickListener() {

            @Override
            public void onClick(View v) {
                View detailsScroll = mView.findViewById(net.yazibacloud.android.R.id.details_scroll);
