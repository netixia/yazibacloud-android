...
public class ShareUserListAdapter extends ArrayAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View view = inflator.inflate(net.yazibacloud.android.R.layout.share_user_item, parent, false);

        if (mShares != null && mShares.size() > position) {
            OCShare share = mShares.get(position);

            TextView userName = (TextView) view.findViewById(net.yazibacloud.android.R.id.userOrGroupName);
            String name = share.getSharedWithDisplayName();
            if (share.getShareType() == ShareType.GROUP) {
                name = getContext().getString(net.yazibacloud.android.R.string.share_group_clarification, name);
            }
            userName.setText(name);

            /// bind listener to edit privileges
            final ImageView editShareButton = (ImageView) view.findViewById(net.yazibacloud.android.R.id.editShareButton);
            ...
            final ImageView unshareButton = (ImageView) view.findViewById(net.yazibacloud.android.R.id.unshareButton);
