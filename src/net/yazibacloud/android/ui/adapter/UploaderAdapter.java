...
import net.yazibacloud.android.datamodel.ThumbnailsCacheManager.AsyncDrawable;
...
public class UploaderAdapter extends SimpleAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View vi = convertView;
        if (convertView == null)
            vi = inflater.inflate(net.yazibacloud.android.R.layout.uploader_list_item_layout, null);

        HashMap<String, OCFile> data = (HashMap<String, OCFile>) getItem(position);
        OCFile file = data.get("dirname");

        TextView filename = (TextView) vi.findViewById(net.yazibacloud.android.R.id.filename);
        filename.setText(file.getFileName());
        
        ImageView fileIcon = (ImageView) vi.findViewById(net.yazibacloud.android.R.id.thumbnail);
