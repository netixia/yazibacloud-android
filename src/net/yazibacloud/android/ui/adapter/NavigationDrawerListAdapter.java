    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (mAll.size() > position) {
            ...
            if (mAll.get(position) instanceof NavigationDrawerItem){
                ...
                View view = inflator.inflate(net.yazibacloud.android.R.layout.drawer_list_item, null);

                LinearLayout itemLayout = (LinearLayout) view.findViewById(net.yazibacloud.android.R.id.itemLayout);
                itemLayout.setContentDescription(navItem.getContentDescription());

                TextView itemText = (TextView) view.findViewById(net.yazibacloud.android.R.id.itemTitle);
                itemText.setText(navItem.getTitle());

                if(navItem.getIcon()!=0) {
                    ImageView itemImage = (ImageView) view.findViewById(net.yazibacloud.android.R.id.itemIcon);
