...
public class MyExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        TextView text = null;
        if (convertView == null) {
            convertView = inflater.inflate(net.yazibacloud.android.R.layout.listrow_details, null);
        }


        text = (TextView) convertView.findViewById(net.yazibacloud.android.R.id.textView1);
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            convertView = inflater.inflate(net.yazibacloud.android.R.layout.listrow_group, null);
        }
