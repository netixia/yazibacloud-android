...
public class LogListAdapter extends ArrayAdapter<String> {
    ...
    public LogListAdapter(Context context, String[] values) {
        super(context, net.yazibacloud.android.R.layout.log_item, values);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(net.yazibacloud.android.R.layout.log_item, parent, false);
        TextView listText = (TextView) rowView.findViewById(net.yazibacloud.android.R.id.log_item_single);
