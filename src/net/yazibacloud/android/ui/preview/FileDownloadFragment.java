...
public class FileDownloadFragment extends FileFragment implements OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(net.yazibacloud.android.R.layout.file_download_fragment, container, false);
        
        ProgressBar progressBar = (ProgressBar)mView.findViewById(net.yazibacloud.android.R.id.progressBar);
        DisplayUtils.colorPreLollipopHorizontalProgressBar(progressBar);
        mProgressListener = new ProgressListener(progressBar);

        (mView.findViewById(net.yazibacloud.android.R.id.cancelBtn)).setOnClickListener(this);
        
        (mView.findViewById(net.yazibacloud.android.R.id.fileDownloadLL)).setOnClickListener(new OnClickListener() {
            @Override
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case net.yazibacloud.android.R.id.cancelBtn: {
    ...
    private void setButtonsForTransferring() {
        getView().findViewById(net.yazibacloud.android.R.id.cancelBtn).setVisibility(View.VISIBLE);

        // show the progress bar for the transfer
        getView().findViewById(net.yazibacloud.android.R.id.progressBar).setVisibility(View.VISIBLE);
        TextView progressText = (TextView) getView().findViewById(net.yazibacloud.android.R.id.progressText);
        progressText.setText(net.yazibacloud.android.R.string.downloader_download_in_progress_ticker);
        progressText.setVisibility(View.VISIBLE);

        // hides the error icon
        getView().findViewById(net.yazibacloud.android.R.id.errorText).setVisibility(View.GONE);
        getView().findViewById(net.yazibacloud.android.R.id.error_image).setVisibility(View.GONE);
    }
    ...
    private void setButtonsForDown() {
        getView().findViewById(net.yazibacloud.android.R.id.cancelBtn).setVisibility(View.GONE);

        // hides the progress bar
        getView().findViewById(net.yazibacloud.android.R.id.progressBar).setVisibility(View.GONE);

        // updates the text message
        TextView progressText = (TextView) getView().findViewById(net.yazibacloud.android.R.id.progressText);
        progressText.setText(net.yazibacloud.android.R.string.common_loading);
        progressText.setVisibility(View.VISIBLE);
    ...
    private void setButtonsForRemote() {
        ...
        getView().findViewById(net.yazibacloud.android.R.id.progressBar).setVisibility(View.GONE);
        getView().findViewById(net.yazibacloud.android.R.id.progressText).setVisibility(View.GONE);

        // shows the error icon and message
        getView().findViewById(net.yazibacloud.android.R.id.errorText).setVisibility(View.VISIBLE);
        getView().findViewById(net.yazibacloud.android.R.id.error_image).setVisibility(View.VISIBLE);
    }
