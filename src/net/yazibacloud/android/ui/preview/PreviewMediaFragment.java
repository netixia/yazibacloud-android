...
import net.yazibacloud.android.media.MediaControlView;
import net.yazibacloud.android.media.MediaService;
import net.yazibacloud.android.media.MediaServiceBinder;
...
public class PreviewMediaFragment extends FileFragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(net.yazibacloud.android.R.layout.file_preview, container, false);

        mImagePreview = (ImageView) mView.findViewById(net.yazibacloud.android.R.id.image_preview);
        mVideoPreview = (VideoView) mView.findViewById(net.yazibacloud.android.R.id.video_preview);
        mVideoPreview.setOnTouchListener(this);

        mMediaController = (MediaControlView) mView.findViewById(net.yazibacloud.android.R.id.media_controller);
        ...
        if (file.isAudio()) {
            try {
                ...
                if (data != null) {
                    ...
                    mImagePreview.setImageResource(net.yazibacloud.android.R.drawable.logo);
                }
            } catch (Throwable t) {
                mImagePreview.setImageResource(net.yazibacloud.android.R.drawable.logo);
            }
