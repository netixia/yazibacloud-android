...
public class PreviewImageActivity extends FileActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(net.yazibacloud.android.R.layout.preview_image_activity);
        ...
        if (isHoneycombOrHigher()) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                getWindow().setStatusBarColor(getResources().getColor(net.yazibacloud.android.R.color.owncloud_blue_dark_transparent));
            }
        }
    ...
    private void initViewPager() {
        ...
        mViewPager = (ExtendedViewPager) findViewById(net.yazibacloud.android.R.id.fragmentPager);
