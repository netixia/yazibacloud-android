...
public class PreviewTextFragment extends FileFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View ret = inflater.inflate(net.yazibacloud.android.R.layout.text_file_preview, container, false);

        mTextPreview = (TextView) ret.findViewById(net.yazibacloud.android.R.id.text_preview);
    ...
    private class TextLoadAsyncTask extends AsyncTask<Object, Void, StringWriter> {
        ...
        public void showLoadingDialog() {
            ...
            if (frag == null) {
                // Construct dialog
                loading = new LoadingDialog(getResources().getString(net.yazibacloud.android.R.string.wait_a_moment));
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        item = menu.findItem(net.yazibacloud.android.R.id.action_download_file);
        if (item != null) {
            item.setVisible(false);
            item.setEnabled(false);
        }
