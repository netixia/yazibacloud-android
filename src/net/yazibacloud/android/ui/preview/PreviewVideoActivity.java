...
public class PreviewVideoActivity extends FileActivity implements OnCompletionListener, OnPreparedListener, OnErrorListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(net.yazibacloud.android.R.layout.video_layout);
        ...
        mVideoPlayer = (VideoView) findViewById(net.yazibacloud.android.R.id.videoPlayer);
            ...
            if (file != null) {
                if (file.isDown()) {
                    ...
                    try {
                        ...
                        onError(null, MediaService.OC_MEDIA_ERROR, net.yazibacloud.android.R.string.media_err_no_account);
                    }
                }
