...
import net.yazibacloud.android.lib.resources.shares.OCShare;
import net.yazibacloud.android.lib.resources.shares.ShareType;
import net.yazibacloud.android.lib.resources.status.OCCapability;
import net.yazibacloud.android.ui.activity.FileActivity;
import net.yazibacloud.android.ui.adapter.ShareUserListAdapter;
import net.yazibacloud.android.ui.dialog.ExpirationDatePickerDialogFragment;
...
//    private static final String FTAG_CHOOSER_DIALOG = "CHOOSER_DIALOG";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(net.yazibacloud.android.R.layout.share_file_layout, container, false);

        // Setup layout
        // Image
        ImageView icon = (ImageView) view.findViewById(net.yazibacloud.android.R.id.shareFileIcon);
        ...
        // Name
        TextView filename = (TextView) view.findViewById(net.yazibacloud.android.R.id.shareFileName);
        filename.setText(mFile.getFileName());
        // Size
        TextView size = (TextView) view.findViewById(net.yazibacloud.android.R.id.shareFileSize);
        if (mFile.isFolder()) {
        ...
        Button addUserGroupButton = (Button)
                view.findViewById(net.yazibacloud.android.R.id.addUserButton);
        addUserGroupButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (shareWithUsersEnable) {
                    ...
                    String message = getString(net.yazibacloud.android.R.string.share_sharee_unavailable);
    ...
    private void initShareViaLinkListener(View shareView) {
        ...
        Switch shareViaLinkSwitch = (Switch) shareView.findViewById(net.yazibacloud.android.R.id.shareViaLinkSectionSwitch);
    ...
    private void initExpirationListener(View shareView) {
        ...
        ((Switch) shareView.findViewById(net.yazibacloud.android.R.id.shareViaLinkExpirationSwitch)).
                setOnCheckedChangeListener(mOnExpirationDateInteractionListener);

        shareView.findViewById(net.yazibacloud.android.R.id.shareViaLinkExpirationLabel).
                setOnClickListener(mOnExpirationDateInteractionListener);

        shareView.findViewById(net.yazibacloud.android.R.id.shareViaLinkExpirationValue).
                setOnClickListener(mOnExpirationDateInteractionListener);
    }
    ...
    private void initPasswordListener(View shareView) {
        ...
        ((Switch) shareView.findViewById(net.yazibacloud.android.R.id.shareViaLinkPasswordSwitch)).
                setOnCheckedChangeListener(mOnPasswordInteractionListener);

        shareView.findViewById(net.yazibacloud.android.R.id.shareViaLinkPasswordLabel).
                setOnClickListener(mOnPasswordInteractionListener);

        shareView.findViewById(net.yazibacloud.android.R.id.shareViaLinkPasswordValue).
                setOnClickListener(mOnPasswordInteractionListener);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        getActivity().setTitle(net.yazibacloud.android.R.string.share_dialog_title);
    ...
    private void updateListOfUserGroups() {
        ...
        mUserGroupsAdapter = new ShareUserListAdapter(
                getActivity(),
                net.yazibacloud.android.R.layout.share_user_item,
                mPrivateShares,
                this
        );

        // Show data
        TextView noShares = (TextView) getView().findViewById(net.yazibacloud.android.R.id.shareNoUsers);
        ListView usersList = (ListView) getView().findViewById(net.yazibacloud.android.R.id.shareUsersList);
        ...
        ScrollView scrollView = (ScrollView) getView().findViewById(net.yazibacloud.android.R.id.shareScroll);
    ...
    private void updatePublicShareSection() {
        if (mPublicShare != null && ShareType.PUBLIC_LINK.equals(mPublicShare.getShareType())) {
            ...
            if (expirationDate > 0) {
                ...
                getExpirationDateValue().setText(net.yazibacloud.android.R.string.empty);
            }
            // recover listener
    ...
    private Switch getShareViaLinkSwitch() {
        return (Switch) getView().findViewById(net.yazibacloud.android.R.id.shareViaLinkSectionSwitch);
    }

    private View getExpirationDateSection() {
        return getView().findViewById(net.yazibacloud.android.R.id.shareViaLinkExpirationSection);
    }

    private Switch getExpirationDateSwitch() {
        return (Switch) getView().findViewById(net.yazibacloud.android.R.id.shareViaLinkExpirationSwitch);
    }

    private TextView getExpirationDateValue() {
        return (TextView) getView().findViewById(net.yazibacloud.android.R.id.shareViaLinkExpirationValue);
    }

    private View getPasswordSection() {
        return getView().findViewById(net.yazibacloud.android.R.id.shareViaLinkPasswordSection);
    }

    private Switch getPasswordSwitch() {
        return (Switch) getView().findViewById(net.yazibacloud.android.R.id.shareViaLinkPasswordSwitch);
    }

    private TextView getPasswordValue() {
        return (TextView) getView().findViewById(net.yazibacloud.android.R.id.shareViaLinkPasswordValue);
    }

    private AppCompatButton getGetLinkButton() {
        return (AppCompatButton) getView().findViewById(net.yazibacloud.android.R.id.shareViaLinkGetLinkButton);
    }
