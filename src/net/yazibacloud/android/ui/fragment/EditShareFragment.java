...
import net.yazibacloud.android.lib.resources.shares.SharePermissionsBuilder;
...
public class EditShareFragment extends Fragment {
    ...
    private static final int sSubordinateCheckBoxIds[] = {
            net.yazibacloud.android.R.id.canEditCreateCheckBox,
            net.yazibacloud.android.R.id.canEditChangeCheckBox,
            net.yazibacloud.android.R.id.canEditDeleteCheckBox
    };
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(net.yazibacloud.android.R.layout.edit_share_layout, container, false);
    ...
    private void refreshUiFromState(View editShareView) {
        if (editShareView != null) {
            ...
            compound = (CompoundButton) editShareView.findViewById(net.yazibacloud.android.R.id.canShareSwitch);
            if(isFederated) {
                compound.setVisibility(View.INVISIBLE);
            }
            compound.setChecked((sharePermissions & OCShare.SHARE_PERMISSION_FLAG) > 0);

            compound = (CompoundButton) editShareView.findViewById(net.yazibacloud.android.R.id.canEditSwitch);
            ...
            if (mFile.isFolder() && !isFederated) {
                compound = (CompoundButton) editShareView.findViewById(net.yazibacloud.android.R.id.canEditCreateCheckBox);
                ...
                compound = (CompoundButton) editShareView.findViewById(net.yazibacloud.android.R.id.canEditChangeCheckBox);
                compound.setChecked((sharePermissions & OCShare.UPDATE_PERMISSION_FLAG) > 0);
                compound.setVisibility(canEdit ? View.VISIBLE : View.GONE);

                compound = (CompoundButton) editShareView.findViewById(net.yazibacloud.android.R.id.canEditDeleteCheckBox);
    ...
    private class OnPrivilegeChangeListener
        ...
        public void onCheckedChanged(CompoundButton compound, boolean isChecked) {
            ...
            switch(compound.getId()) {
                case net.yazibacloud.android.R.id.canShareSwitch:
                    Log_OC.v(TAG, "canShareCheckBox toggled to " + isChecked);
                    updatePermissionsToShare();
                    break;

                case net.yazibacloud.android.R.id.canEditSwitch:
                ...
                case net.yazibacloud.android.R.id.canEditCreateCheckBox:
                    Log_OC.v(TAG, "canEditCreateCheckBox toggled to " + isChecked);
                    syncCanEditSwitch(compound, isChecked);
                    updatePermissionsToShare();
                    break;

                case net.yazibacloud.android.R.id.canEditChangeCheckBox:
                    Log_OC.v(TAG, "canEditChangeCheckBox toggled to " + isChecked);
                    syncCanEditSwitch(compound, isChecked);
                    updatePermissionsToShare();
                    break;

                case net.yazibacloud.android.R.id.canEditDeleteCheckBox:
        ...
        private void syncCanEditSwitch(View subordinateCheckBoxView, boolean isChecked) {
            CompoundButton canEditCompound = (CompoundButton) getView().findViewById(net.yazibacloud.android.R.id.canEditSwitch);
            if (isChecked) {
    ...
    private Switch getCanShareSwitch() {
        return (Switch) getView().findViewById(net.yazibacloud.android.R.id.canShareSwitch);
    }
    ...
    private Switch getCanEditSwitch() {
        return (Switch) getView().findViewById(net.yazibacloud.android.R.id.canEditSwitch);
    }
    ...
    private CheckBox getCanEditCreateCheckBox() {
        return (CheckBox) getView().findViewById(net.yazibacloud.android.R.id.canEditCreateCheckBox);
    }
    ...
    private CheckBox getCanEditChangeCheckBox() {
        return (CheckBox) getView().findViewById(net.yazibacloud.android.R.id.canEditChangeCheckBox);
    }
    ...
    private CheckBox getCanEditDeleteCheckBox() {
        return (CheckBox) getView().findViewById(net.yazibacloud.android.R.id.canEditDeleteCheckBox);
    }
