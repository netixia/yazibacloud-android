...
import net.yazibacloud.android.providers.UsersAndGroupsSearchProvider;
import net.yazibacloud.android.ui.dialog.ShareLinkToDialog;
import net.yazibacloud.android.ui.fragment.EditShareFragment;
import net.yazibacloud.android.ui.fragment.SearchShareesFragment;
import net.yazibacloud.android.ui.fragment.ShareFileFragment;
import net.yazibacloud.android.ui.fragment.ShareFragmentListener;
import net.yazibacloud.android.utils.GetShareWithUsersAsyncTask;
...
public class ShareActivity extends FileActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(net.yazibacloud.android.R.layout.share_activity);
        ...
        if (savedInstanceState == null) {
            ...
            ft.replace(net.yazibacloud.android.R.id.share_fragment_container, fragment, TAG_SHARE_FRAGMENT);
            ft.commit();
        }
    ...
    public void showSearchUsersAndGroups() {
        ...
        ft.replace(net.yazibacloud.android.R.id.share_fragment_container, searchFragment, TAG_SEARCH_FRAGMENT);
    ...
    public void showEditShare(OCShare share) {
        ...
        ft.replace(net.yazibacloud.android.R.id.share_fragment_container, editShareFragment, TAG_EDIT_SHARE_FRAGMENT);
    ...
    public void refreshUsersOrGroupsListFromServer() {
        // Show loading
        showLoadingDialog(getString(net.yazibacloud.android.R.string.common_loading));
