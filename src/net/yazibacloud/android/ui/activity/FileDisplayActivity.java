...
import net.yazibacloud.android.MainApp;
...
import net.yazibacloud.android.files.services.FileUploader.FileUploaderBinder;
import net.yazibacloud.android.lib.common.network.CertificateCombinedException;
...
import net.yazibacloud.android.lib.common.operations.RemoteOperationResult.ResultCode;
import net.yazibacloud.android.lib.common.utils.Log_OC;
...
import net.yazibacloud.android.operations.RefreshFolderOperation;
...
import net.yazibacloud.android.services.observer.FileObserverService;
import net.yazibacloud.android.syncadapter.FileSyncAdapter;
import net.yazibacloud.android.ui.dialog.ConfirmationDialogFragment;
import net.yazibacloud.android.ui.dialog.SslUntrustedCertDialog;
import net.yazibacloud.android.ui.fragment.FileDetailFragment;
import net.yazibacloud.android.ui.fragment.FileFragment;
import net.yazibacloud.android.ui.fragment.OCFileListFragment;
import net.yazibacloud.android.ui.preview.PreviewImageActivity;
import net.yazibacloud.android.ui.preview.PreviewImageFragment;
import net.yazibacloud.android.ui.preview.PreviewMediaFragment;
import net.yazibacloud.android.ui.preview.PreviewTextFragment;
import net.yazibacloud.android.ui.preview.PreviewVideoActivity;
import net.yazibacloud.android.utils.DisplayUtils;
import net.yazibacloud.android.utils.ErrorMessageAdapter;
import net.yazibacloud.android.utils.FileStorageUtils;
import net.yazibacloud.android.utils.PermissionUtil;
import net.yazibacloud.android.utils.UriUtils;
...
public class FileDisplayActivity extends HookActivity
        ...
        SslUntrustedCertDialog.OnSslUntrustedCertListener, OnEnforceableRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(net.yazibacloud.android.R.layout.files);

        // Navigation Drawer
        initDrawer();

        mProgressBar = (ProgressBar) findViewById(net.yazibacloud.android.R.id.progressBar);
        mProgressBar.setIndeterminateDrawable(
                ContextCompat.getDrawable(this,
                        net.yazibacloud.android.R.drawable.actionbar_progress_indeterminate_horizontal));

        mDualPane = getResources().getBoolean(net.yazibacloud.android.R.bool.large_land_layout);
        mLeftFragmentContainer = findViewById(net.yazibacloud.android.R.id.left_fragment_container);
        mRightFragmentContainer = findViewById(net.yazibacloud.android.R.id.right_fragment_container);
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        if (PermissionUtil.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            ...
            if (PermissionUtil.shouldShowRequestPermissionRationale(this,
                ...
                Snackbar snackbar = Snackbar.make(findViewById(net.yazibacloud.android.R.id.ListLayout), net.yazibacloud.android.R.string.permission_storage_access,
                        Snackbar.LENGTH_INDEFINITE)
                        .setAction(net.yazibacloud.android.R.string.common_ok, new View.OnClickListener() {
                            @Override
    ...
    protected void onAccountSet(boolean stateWasRecovered) {
        ...
        if (getAccount() != null) {
            ...
            if (mAccountWasSet) {
                setUsernameInDrawer((RelativeLayout) findViewById(net.yazibacloud.android.R.id.left_drawer), getAccount());
            }
    ...
    private void createMinFragments() {
        ...
        transaction.add(net.yazibacloud.android.R.id.left_fragment_container, listOfFiles, TAG_LIST_OF_FILES);
        transaction.commit();
    }
    ...
    private void setSecondFragment(Fragment fragment) {
        FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
        transaction.replace(net.yazibacloud.android.R.id.right_fragment_container, fragment, TAG_SECOND_FRAGMENT);
        transaction.commit();
    }
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        menu.findItem(net.yazibacloud.android.R.id.action_sort).setVisible(!drawerOpen);
        menu.findItem(net.yazibacloud.android.R.id.action_sync_account).setVisible(!drawerOpen);
        menu.findItem(net.yazibacloud.android.R.id.action_switch_view).setVisible(!drawerOpen);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(net.yazibacloud.android.R.menu.main_menu, menu);
        menu.findItem(net.yazibacloud.android.R.id.action_create_dir).setVisible(false);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case net.yazibacloud.android.R.id.action_sync_account: {
                startSynchronization();
                break;
            }
            ...
            case net.yazibacloud.android.R.id.action_sort: {
                ...
                builder.setTitle(net.yazibacloud.android.R.string.actionbar_sort_title)
                        .setSingleChoiceItems(net.yazibacloud.android.R.array.actionbar_sortby, sortOrder ,
            ...
            case net.yazibacloud.android.R.id.action_switch_view:{
                if (isGridView()){
                    item.setTitle(getString(net.yazibacloud.android.R.string.action_switch_grid_view));
                    item.setIcon(ContextCompat.getDrawable(getApplicationContext(),
                            net.yazibacloud.android.R.drawable.ic_view_module));
                    getListOfFilesFragment().setListAsPreferred();
                } else {
                    item.setTitle(getApplicationContext().getString(net.yazibacloud.android.R.string.action_switch_list_view));
                    item.setIcon(ContextCompat.getDrawable(getApplicationContext(),
                            net.yazibacloud.android.R.drawable.ic_view_list));
    ...
    private void requestMultipleUpload(Intent data, int resultCode) {
        ...
        if (filePaths != null) {
            ...
            Toast t = Toast.makeText(this, getString(net.yazibacloud.android.R.string.filedisplay_no_file_selected),
                    Toast.LENGTH_LONG);
            t.show();
            return;
        }
        ...
        try {
            ...
            if (filePath == null) {
                ...
                Toast t = Toast.makeText(
                        this, getString(net.yazibacloud.android.R.string.filedisplay_unexpected_bad_get_content),
                        Toast.LENGTH_LONG
                );
                t.show();
                return;
                    ...
                    if (FileSyncAdapter.EVENT_FULL_SYNC_START.equals(event)) {
                        ...
                        if (currentDir == null) {
                            ...
                            Toast.makeText( FileDisplayActivity.this, 
                                            String.format(
                                                    getString(net.yazibacloud.android.R.string.
    ...
    private void setBackgroundText() {
        ...
        if (ocFileListFragment != null) {
            int message = net.yazibacloud.android.R.string.file_list_loading;
            if (!mSyncInProgress) {
                // In case file list is empty
                message = net.yazibacloud.android.R.string.file_list_empty;
            }
                ...
                if (sameAccount && sameFile && detailFragmentIsShown) {
                    ...
                    if (renamedInUpload) {
                        ...
                        Toast msg = Toast.makeText(
                                context,
                                String.format(
                                        getString(net.yazibacloud.android.R.string.filedetails_renamed_in_upload_msg),
                                        newName),
                                Toast.LENGTH_LONG);
                        msg.show();
                    }
    ...
    public void onFailedSavingCertificate() {
        ConfirmationDialogFragment dialog = ConfirmationDialogFragment.newInstance(
                net.yazibacloud.android.R.string.ssl_validator_not_saved, new String[]{}, net.yazibacloud.android.R.string.common_ok, -1, -1
        );
