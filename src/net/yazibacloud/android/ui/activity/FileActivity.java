...
import net.yazibacloud.android.lib.common.OwnCloudAccount;
import net.yazibacloud.android.lib.common.OwnCloudClient;
import net.yazibacloud.android.lib.common.OwnCloudClientManagerFactory;
import net.yazibacloud.android.lib.common.OwnCloudCredentials;
import net.yazibacloud.android.lib.common.operations.OnRemoteOperationListener;
...
import net.yazibacloud.android.operations.GetSharesForFileOperation;
...
import net.yazibacloud.android.ui.NavigationDrawerItem;
import net.yazibacloud.android.ui.adapter.NavigationDrawerListAdapter;
import net.yazibacloud.android.ui.dialog.LoadingDialog;
import net.yazibacloud.android.ui.dialog.SharePasswordDialogFragment;
...
//    protected boolean mShowAccounts = false;
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        if (mDrawerToggle != null) {
            ...
            if (isDrawerOpen()) {
                getSupportActionBar().setTitle(net.yazibacloud.android.R.string.app_name);
    ...
    protected void initDrawer(){
        ...
        mDrawerLayout = (DrawerLayout) findViewById(net.yazibacloud.android.R.id.drawer_layout);
        // Notification Drawer
        RelativeLayout navigationDrawerLayout = (RelativeLayout) findViewById(net.yazibacloud.android.R.id.left_drawer);
        mDrawerList = (ListView) navigationDrawerLayout.findViewById(net.yazibacloud.android.R.id.drawer_list);
...
//        }
        ...
        mDrawerTitles = getResources().getStringArray(net.yazibacloud.android.R.array.drawer_items);

        // nav drawer content description from resources
        mDrawerContentDescriptions = getResources().
                getStringArray(net.yazibacloud.android.R.array.drawer_content_descriptions);
        ...
        mDrawerItems.add(new NavigationDrawerItem(mDrawerTitles[0], mDrawerContentDescriptions[0],
                net.yazibacloud.android.R.drawable.ic_folder_open));
        ...
        mDrawerItems.add(new NavigationDrawerItem(mDrawerTitles[1], mDrawerContentDescriptions[1],
                net.yazibacloud.android.R.drawable.ic_settings));
        // Logs
        if (BuildConfig.DEBUG) {
            mDrawerItems.add(new NavigationDrawerItem(mDrawerTitles[2],
                    mDrawerContentDescriptions[2], net.yazibacloud.android.R.drawable.ic_log));
        }
        ...
        mDrawerToggle = new ActionBarDrawerToggle(this, mDrawerLayout, net.yazibacloud.android.R.string.drawer_open, net.yazibacloud.android.R.string.drawer_close) {
    ...
    protected void setUsernameInDrawer(RelativeLayout navigationDrawerLayout, Account account) {
        if (navigationDrawerLayout != null && account != null) {
            TextView username = (TextView) navigationDrawerLayout.findViewById(net.yazibacloud.android.R.id.drawer_username);
            int lastAtPos = account.name.lastIndexOf("@");
            username.setText(account.name.substring(0, lastAtPos));
        }
    }
    ...
    protected void updateActionBarTitleAndHomeButton(OCFile chosenFile) {
        String title = getString(net.yazibacloud.android.R.string.default_display_name_for_root_folder);    // default
        boolean inRoot;
    ...
    public void onRemoteOperationFinish(RemoteOperation operation, RemoteOperationResult result) {
        ...
        if (!result.isSuccess() && (
            ...
            if (result.isSuccess() || result.getCode() == RemoteOperationResult.ResultCode.SHARE_NOT_FOUND) {
                updateFileFromDB();
    ...
    protected void requestCredentialsUpdate(Context context) {
        ...
        } catch (net.yazibacloud.android.lib.common.accounts.AccountUtils.AccountNotFoundException e) {
            Toast.makeText(context, net.yazibacloud.android.R.string.auth_account_does_not_exist, Toast.LENGTH_SHORT).show();
        }
