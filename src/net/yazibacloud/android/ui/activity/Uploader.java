...
import net.yazibacloud.android.authentication.AccountAuthenticator;
...
import net.yazibacloud.android.ui.adapter.UploaderAdapter;
import net.yazibacloud.android.ui.dialog.CreateFolderDialogFragment;
import net.yazibacloud.android.ui.dialog.LoadingDialog;
import net.yazibacloud.android.utils.CopyTmpFileAsyncTask;
...
public class Uploader extends FileActivity
    ...
    protected Dialog onCreateDialog(final int id) {
        ...
        switch (id) {
        case DIALOG_WAITING:
            final ProgressDialog pDialog = new ProgressDialog(this, net.yazibacloud.android.R.style.ProgressDialogTheme);
            pDialog.setIndeterminate(false);
            pDialog.setCancelable(false);
            pDialog.setMessage(getResources().getString(net.yazibacloud.android.R.string.uploader_info_uploading));
            pDialog.setOnShowListener(new DialogInterface.OnShowListener() {
                ...
                public void onShow(DialogInterface dialog) {
                    ...
                    v.getIndeterminateDrawable().setColorFilter(getResources().getColor(net.yazibacloud.android.R.color.color_accent),
        ...
        case DIALOG_NO_ACCOUNT:
            ...
            builder.setTitle(net.yazibacloud.android.R.string.uploader_wrn_no_account_title);
            builder.setMessage(String.format(
                    getString(net.yazibacloud.android.R.string.uploader_wrn_no_account_text), getString(net.yazibacloud.android.R.string.app_name)));
            builder.setCancelable(false);
            builder.setPositiveButton(net.yazibacloud.android.R.string.uploader_wrn_no_account_setup_btn_text, new OnClickListener() {
                @Override
            ...
            builder.setNegativeButton(net.yazibacloud.android.R.string.uploader_wrn_no_account_quit_btn_text, new OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    finish();
                }
        ...
        case DIALOG_MULTIPLE_ACCOUNT:
            ...
            builder.setTitle(net.yazibacloud.android.R.string.common_choose_account);
        ...
        case DIALOG_NO_STREAM:
            builder.setIcon(android.R.drawable.ic_dialog_alert);
            builder.setTitle(net.yazibacloud.android.R.string.uploader_wrn_no_content_title);
            builder.setMessage(net.yazibacloud.android.R.string.uploader_wrn_no_content_text);
            builder.setCancelable(false);
            builder.setNegativeButton(net.yazibacloud.android.R.string.common_cancel, new OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    finish();
                }
    ...
    public void onClick(View v) {
        // click on button
        switch (v.getId()) {
        case net.yazibacloud.android.R.id.uploader_choose_folder:
        ...
        case net.yazibacloud.android.R.id.uploader_cancel:
            finish();
            break;
    ...
    private void populateDirectoryList() {
        setContentView(net.yazibacloud.android.R.layout.uploader_layout);
        
        ListView mListView = (ListView) findViewById(android.R.id.list);

        String current_dir = mParents.peek();
        if(current_dir.equals("")){
            getSupportActionBar().setTitle(getString(net.yazibacloud.android.R.string.default_display_name_for_root_folder));
        }
        else{
        ...
        if (mFile != null) {
            ...
            UploaderAdapter sa = new UploaderAdapter(this,
                                                data,
                                                net.yazibacloud.android.R.layout.uploader_list_item_layout,
                                                new String[] {"dirname"},
                                                new int[] {net.yazibacloud.android.R.id.filename},
                                                getStorageManager(), getAccount());
            
            mListView.setAdapter(sa);
            Button btnChooseFolder = (Button) findViewById(net.yazibacloud.android.R.id.uploader_choose_folder);
            btnChooseFolder.setOnClickListener(this);
            
            Button btnNewFolder = (Button) findViewById(net.yazibacloud.android.R.id.uploader_cancel);
    ...
    public void uploadFiles() {
        try {
            ...
            String message = String.format(getString(net.yazibacloud.android.R.string.uploader_error_forbidden_content),
                    getString(net.yazibacloud.android.R.string.app_name));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.findItem(net.yazibacloud.android.R.id.action_sort).setVisible(false);
        menu.findItem(net.yazibacloud.android.R.id.action_sync_account).setVisible(false);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case net.yazibacloud.android.R.id.action_create_dir:
                    ...
                    if (FileSyncAdapter.EVENT_FULL_SYNC_START.equals(event)) {
                        ...
                        if (currentDir == null) {
                            ...
                            Toast.makeText(context,
                                    String.format(
                                            getString(net.yazibacloud.android.R.string.sync_current_folder_was_removed),
    ...
    public void showWaitingCopyDialog() {
        ...
        LoadingDialog loading = new LoadingDialog(
                getResources().getString(net.yazibacloud.android.R.string.wait_for_tmp_copy_from_private_storage));
