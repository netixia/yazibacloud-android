...
public class PassCodeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(net.yazibacloud.android.R.layout.passcodelock);
        
        mBCancel = (Button) findViewById(net.yazibacloud.android.R.id.cancel);
        mPassCodeHdr = (TextView) findViewById(net.yazibacloud.android.R.id.header);
        mPassCodeHdrExplanation = (TextView) findViewById(net.yazibacloud.android.R.id.explanation);
        mPassCodeEditTexts[0] = (EditText) findViewById(net.yazibacloud.android.R.id.txt0);
        mPassCodeEditTexts[0].requestFocus();
        getWindow().setSoftInputMode(
                android.view.WindowManager.LayoutParams.SOFT_INPUT_STATE_VISIBLE);
        mPassCodeEditTexts[1] = (EditText) findViewById(net.yazibacloud.android.R.id.txt1);
        mPassCodeEditTexts[2] = (EditText) findViewById(net.yazibacloud.android.R.id.txt2);
        mPassCodeEditTexts[3] = (EditText) findViewById(net.yazibacloud.android.R.id.txt3);

        if (ACTION_CHECK.equals(getIntent().getAction())) {
            /// this is a pass code request; the user has to input the right value
            mPassCodeHdr.setText(net.yazibacloud.android.R.string.pass_code_enter_pass_code);
            ...
            if(mConfirmingPassCode){
                ...
                mPassCodeHdr.setText(net.yazibacloud.android.R.string.pass_code_configure_your_pass_code);
            ...
            mPassCodeHdr.setText(net.yazibacloud.android.R.string.pass_code_remove_your_pass_code);
            mPassCodeHdrExplanation.setVisibility(View.INVISIBLE);
            setCancelButtonEnabled(true);
    ...
    private void processFullPassCode() {
        if (ACTION_CHECK.equals(getIntent().getAction())) {
            if (checkPassCode()) {
                ...
                showErrorAndRestart(net.yazibacloud.android.R.string.pass_code_wrong, net.yazibacloud.android.R.string.pass_code_enter_pass_code,
                        View.INVISIBLE);
            }
            ...
            if (!mConfirmingPassCode) {
                ...
                showErrorAndRestart(
                        net.yazibacloud.android.R.string.pass_code_mismatch, net.yazibacloud.android.R.string.pass_code_configure_your_pass_code, View.VISIBLE
                );
            }
        }
    }
    ...
    protected void requestPassCodeConfirmation(){
        clearBoxes();
        mPassCodeHdr.setText(net.yazibacloud.android.R.string.pass_code_reenter_your_pass_code);
        mPassCodeHdrExplanation.setVisibility(View.INVISIBLE);
