...
public class GenericExplanationActivity  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(net.yazibacloud.android.R.layout.generic_explanation);
        
        if (message != null) {
            TextView textView = (TextView) findViewById(net.yazibacloud.android.R.id.message);
            textView.setText(message);
            textView.setMovementMethod(new ScrollingMovementMethod());
        }
        
        ListView listView = (ListView) findViewById(net.yazibacloud.android.R.id.list);
