...
public class MediaControlView extends FrameLayout /* implements OnLayoutChangeListener, OnTouchListener */ implements OnClickListener, OnSeekBarChangeListener {
    ...
    public MediaControlView(Context context, AttributeSet attrs) {
        ...
        mRoot = inflate.inflate(net.yazibacloud.android.R.layout.media_control, null);
    ...
    */
    ...
    private void initControllerView(View v) {
        mPauseButton = (ImageButton) v.findViewById(net.yazibacloud.android.R.id.playBtn);
        if (mPauseButton != null) {
            mPauseButton.requestFocus();
            mPauseButton.setOnClickListener(this);
        }

        mFfwdButton = (ImageButton) v.findViewById(net.yazibacloud.android.R.id.forwardBtn);
        if (mFfwdButton != null) {
            mFfwdButton.setOnClickListener(this);
        }

        mRewButton = (ImageButton) v.findViewById(net.yazibacloud.android.R.id.rewindBtn);
        if (mRewButton != null) {
            mRewButton.setOnClickListener(this);
        }

        mProgress = (ProgressBar) v.findViewById(net.yazibacloud.android.R.id.progressBar);
        if (mProgress != null) {
        ...
        mEndTime = (TextView) v.findViewById(net.yazibacloud.android.R.id.totalTimeText);
        mCurrentTime = (TextView) v.findViewById(net.yazibacloud.android.R.id.currentTimeText);
    ...
    public void onClick(View v) {
        ...
        case net.yazibacloud.android.R.id.playBtn:
            doPauseResume();
            break;

        case net.yazibacloud.android.R.id.rewindBtn:
        ...
        case net.yazibacloud.android.R.id.forwardBtn:
            pos = mPlayer.getCurrentPosition();
            pos += 15000;
            mPlayer.seekTo(pos);
            if (!playing) mPlayer.pause(); // necessary in some 2.3.x devices
