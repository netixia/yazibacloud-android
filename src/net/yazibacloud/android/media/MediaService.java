...
package net.yazibacloud.android.media;
...
public class MediaService extends Service implements OnCompletionListener, OnPreparedListener,
    ...
    public static String getMessageForMediaError(Context context, int what, int extra) {
        ...
        if (what == OC_MEDIA_ERROR) {
             ...
             */
            messageId = net.yazibacloud.android.R.string.media_err_unsupported;
             ...
             */
            messageId = net.yazibacloud.android.R.string.media_err_io;
             ...
             */
            messageId = net.yazibacloud.android.R.string.media_err_malformed;
            ...
            */
            messageId = net.yazibacloud.android.R.string.media_err_timeout;
            ...
            */
            messageId = net.yazibacloud.android.R.string.media_err_invalid_progressive_playback;
            ...
            */
             ...
             */
            messageId = net.yazibacloud.android.R.string.media_err_unknown;
        }
    ...
    public void onCreate() {
        ...
        mNotificationBuilder.setColor(this.getResources().getColor(net.yazibacloud.android.R.color.primary));
    ...
    protected void processPlayRequest() {
        ...
        if (mState == State.STOPPED) {
            ...
            setUpAsForeground(String.format(getString(net.yazibacloud.android.R.string.media_state_playing), mFile.getFileName()));
    ...
    protected void playMedia() {
        ...
        try {
            if (mFile == null) { 
                Toast.makeText(this, net.yazibacloud.android.R.string.media_err_nothing_to_play, Toast.LENGTH_LONG).show();
                processStopRequest(true);
                return;
                
            } else if (mAccount == null) {
                Toast.makeText(this, net.yazibacloud.android.R.string.media_err_not_in_owncloud, Toast.LENGTH_LONG).show();
                processStopRequest(true);
                return;
            }
            ...
            */
            ...
            setUpAsForeground(String.format(getString(net.yazibacloud.android.R.string.media_state_loading), mFile.getFileName()));
            ...
            Toast.makeText(this, String.format(getString(net.yazibacloud.android.R.string.media_err_security_ex), mFile.getFileName()), Toast.LENGTH_LONG).show();
            processStopRequest(true);
            
        } catch (IOException e) {
            Log_OC.e(TAG, "IOException playing " + mAccount.name + mFile.getRemotePath(), e);
            Toast.makeText(this, String.format(getString(net.yazibacloud.android.R.string.media_err_io_ex), mFile.getFileName()), Toast.LENGTH_LONG).show();
            processStopRequest(true);
            
        } catch (IllegalStateException e) {
            Log_OC.e(TAG, "IllegalStateException " + mAccount.name + mFile.getRemotePath(), e);
            Toast.makeText(this, String.format(getString(net.yazibacloud.android.R.string.media_err_unexpected), mFile.getFileName()), Toast.LENGTH_LONG).show();
            processStopRequest(true);
    ...
    public void onCompletion(MediaPlayer player) {
        Toast.makeText(this, String.format(getString(net.yazibacloud.android.R.string.media_event_done, mFile.getFileName())), Toast.LENGTH_LONG).show();
    ...
    public void onPrepared(MediaPlayer player) {
        mState = State.PLAYING;
        updateNotification(String.format(getString(net.yazibacloud.android.R.string.media_state_playing), mFile.getFileName()));
        if (mMediaController != null) {
    ...
    private void updateNotification(String content) {
        String ticker = String.format(getString(net.yazibacloud.android.R.string.media_notif_ticker), getString(net.yazibacloud.android.R.string.app_name));
        ...
        mNotificationManager.notify(net.yazibacloud.android.R.string.media_notif_ticker, mNotificationBuilder.build());
    }
    ...
    private void setUpAsForeground(String content) {
        ...
        mNotificationBuilder.setSmallIcon(net.yazibacloud.android.R.drawable.ic_play_arrow);
        ...
        startForeground(net.yazibacloud.android.R.string.media_notif_ticker, mNotificationBuilder.build());
    }
